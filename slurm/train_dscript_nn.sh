...
srun python /nfs/home/students/t.reim/bachelor/pytorchtest/main.py -data gold_stand -model dscript_like -max 2000 -lr 0.001 -epoch 25 -batch 10 -sub -subsize 0.2 -emb -emb_dim 1280 -wandb